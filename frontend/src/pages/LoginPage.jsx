      ...
      <h2 className='font-medium tex-2xl flex justify-between items-center'>
        ...
        {isDataSubmitted && <img onClick={()=> setIsDataSubmitted(false)} src={assets.arrow_icon} alt="" className='w-5 cursor-pointer' /> }
           ...
           {!isDataSubmitted && (
            ...
            value={email}
            type="email" placeholder='Enter Email address' required className='p-2 border border-gray-500 rounded-md focus:outline-none focus:rinf-2 focus:ring-indigo-500'/>
           ...
           <button type='submit' className='py-3 bg-gradient-to-r from-purpl-400 to-violet-600 text-white rounded-md cursor-pointer'>{currState === "Sign up" ? "Create Account": "Login Now"}</button>
